...
const WalletConnectModal = () => {
  ...
  return (
    <div className={`fixed z-[80] inset-0 overflow-y-auto flex items-center justify-center p-5 md:p-10 ${showModal ? 'flex' : 'hidden'}`}>
      <div className="z-20 max-w-[500px] bg-white rounded-lg px-4 py-8">
